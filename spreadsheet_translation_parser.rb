...
destination = ARGV[1]
  ...
  dic.each do |key, value|
    ...
    if (words.size < 2) and ((s1 == "identifier") || (s1 == "where") || (s1 == "patient") || (s1 == "period") || (s1 =~ /\w+\.\w+/) || (s1 =~ /\w+\.\w+.\w+/) || (s1 =~ /\w+\.\w+.\w+.\w+/)) # если ключ из 1 слова, то... надо проверить, что это не слово Identifier или что-то вроде этого - т.е. тип данных
