...
ARGF.each do |file|	
  ...
  dic.each do |key, value|
    ...
    if (words.size < 2) and ((s1 == "Identifier") || (s1 == "where") || (s1 == "patient"))# если ключ из 1 слова, то... надо проверить, что это не слово Identifier или что-то вроде этого - т.е. тип данных
      puts "Skipping: " + s1
    else
